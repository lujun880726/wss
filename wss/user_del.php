...
if ((isset($_GET['UID'])) && ($_GET['UID'] != "") && ($_SESSION['MM_Username'] <> $multilingual_dd_user_readonly)) {
  $deleteSQL = sprintf("DELETE FROM tk_user WHERE uid=%s",
