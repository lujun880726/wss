      ...
      <td width="75%" valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="5" align="center">
          <tr>
            <td><div class="col-xs-12">
                <h3><?php echo $multilingual_announcement_edit_title; ?></h3>
              </div>
              <div class="form-group col-xs-12">
                <label for="tk_anc_title"><?php echo $multilingual_announcement_title; ?><span id="anntitle" class="red">*</span></label>
                <div>
				<input type="text" name="tk_anc_title" id="tk_anc_title" value="<?php echo $row_Recordset1['tk_anc_title']; ?>" class="form-control" placeholder="<?php echo $multilingual_announcement_title; ?>" />   
                </div>
              </div>
              ...
              <div class="form-group col-xs-12">
                ...
                <div>
				<textarea name="tk_anc_text" id="tk_anc_text"><?php echo $row_Recordset1['tk_anc_text']; ?></textarea>
                </div>
              </div>
